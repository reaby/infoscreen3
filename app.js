...
let displays = require("./modules/websocket")(server, app, io, eventDispatcher);
let indexRouter = require('./routes/index.js')(displays);
let adminRouter = require('./routes/admin.js')(displays);
